window.onload = function(){ //função para iniciar a tela só quando carregar a página
            ...
            function cobrasenai(){
                ...
                for (var i = 0; i < rastro.length; i++) {   
                    ...
                    // do contrário ele só apareria se batesse na calda e não em qualquer parte do vetor
                ...
                if (frutax==x && frutay==y){
                    ...
                    //refazer a verificação da posição da cobra para randomizar a posição da fruta
                    for (var i = 0; i < rastro.length; i++){
